...
public class CreditTest {
    ...
    void setup() {
        ...
        cash.creditCardButton.click();

    }

    @Test
    @DisplayName("Появление формы кредита")
    public void fieldShouldAppear() {
        cash.form.should(appear);
        cash.creditHeader.should(appear);
    }
    ...
    void shouldCreateItem() {
        ...
        cash.proceedButton.click();
        cash.succeedNotification.should(appear, Duration.ofSeconds(15));
        Assertions.assertEquals(SqlHelperCredit.getCardIdOrder(), SqlHelperCredit.getCardIdCredit());
    }
    ...
    void shouldCheckStatusApproved() {
        ...
        cash.proceedButton.click();
        cash.succeedNotification.should(appear, Duration.ofSeconds(15));
        Assertions.assertEquals("APPROVED", SqlHelperCredit.getCardStatusApproved());
    }
    ...
    void shouldCheckStatusDeclined() {
        ...
        cash.proceedButton.click();
        cash.succeedNotification.should(appear, Duration.ofSeconds(15));
        Assertions.assertEquals("DECLINED", SqlHelperCredit.getCardStatusDeclined());
    }
}
